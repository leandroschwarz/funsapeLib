...
void static inline usartTransmitStd(int8_t data, FILE * stream);
int16_t static inline usartReceiveStd(FILE * stream);

// -----------------------------------------------------------------------------
// Global variables ------------------------------------------------------------

static FILE usartStream = FDEV_SETUP_STREAM(usartTransmitStd, usartReceiveStd, _FDEV_SETUP_RW);
