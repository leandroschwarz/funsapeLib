...
#	error	[funsapeLibDateTime.cpp] Error 16 - Header file (funsapeLibDateTime.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_DATE_TIME_HPP != __BUILD_TO_REPLACE__
#	error	[funsapeLibDateTime.cpp] Error 17 - Build mismatch between source (funsapeLibDateTime.cpp) and header (funsapeLibDateTime.hpp) files!
#endif
...
DateTime::DateTime(void)
{
	...
	debugMark("DateTime::DateTime(void)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::isDateSet(void)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::isDateSet(void)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::isTimeSet(void)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::isTimeSet(void)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::getDate(uint16_t *year_p, Month *month_p, uint8_t *day_p, WeekDay *weekDay_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::getDate(uint16_t *, Month *, uint8_t *, WeekDay *)", DEBUG_CODE_DATE_TIME);

	// Checks initialization
	if(!this->_dateSet) {
		// Returns error
		this->_lastError = Error::DATE_NOT_INITIALIZED;
		debugMessage(Error::DATE_NOT_INITIALIZED);
		return false;
	}
 ...
 * @return false
 */
bool DateTime::getWeekDay(WeekDay *weekDay_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::getWeekDay(WeekDay *)", DEBUG_CODE_DATE_TIME);
...
{
	// Mark passage for debugging purpose
	debugMark("DateTime::isLeapYear(void)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::setDate(cuint16_t year_p, const Month month_p, cuint8_t day_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::setDate(cuint16_t, const Month, cuint8_t)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::getTime(uint8_t *hours_p, uint8_t *minutes_p, uint8_t *seconds_p, const TimeFormat timeFormat_p, AmPmFlag *amPmFlag_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::getTime(uint8_t *, uint8_t *, uint8_t *, const TimeFormat, AmPmFlag *)", DEBUG_CODE_DATE_TIME);
	...
	if(!this->_timeSet) {
		...
		debugMessage(Error::TIME_NOT_INITIALIZED);
		return false;
	}
	// CHECK FOR ERROR - pointer null
 ...
 * @return false
 */
bool DateTime::getTime(uint8_t *hours_p, uint8_t *minutes_p, uint8_t *seconds_p, uint16_t *milliseconds_p, const TimeFormat timeFormat_p, AmPmFlag *amPmFlag_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::getTime(uint8_t *, uint8_t *, uint8_t *, uint16_t *, const TimeFormat, AmPmFlag *)", DEBUG_CODE_DATE_TIME);
	...
	// CHECK FOR ERROR - pointer null
	if((!isPointerValid(hours_p)) || (!isPointerValid(minutes_p)) || (!isPointerValid(seconds_p)) || (!isPointerValid(milliseconds_p))) {
		// Returns error
		this->_lastError = Error::ARGUMENT_POINTER_NULL;
		debugMessage(Error::ARGUMENT_POINTER_NULL);
		return false;
 ...
 * @return false
 */
bool DateTime::getTimeFormat(TimeFormat *timeFormat_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::getTimeFormat(TimeFormat *)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::getTimeZone(TimeZone *timeZone_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::getTimeZone(TimeZone *)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::setTime(cuint8_t hours_p, cuint8_t minutes_p, cuint8_t seconds_p, const TimeFormat timeFormat_p, const AmPmFlag amPmFlag_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::setTime(cuint8_t, cuint8_t, cuint8_t, const TimeFormat, const AmPmFlag)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::setTime(cuint8_t hours_p, cuint8_t minutes_p, cuint8_t seconds_p, cuint16_t milliseconds_p, const TimeFormat timeFormat_p, const AmPmFlag amPmFlag_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::setTime(cuint8_t, cuint8_t, cuint8_t, cuint16_t, const TimeFormat, const AmPmFlag)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::setTimeFormat(const TimeFormat timeFormat_p)
{
	// Local variables
	...
	// Mark passage for debugging purpose
	debugMark("DateTime::setTimeFormat(const TimeFormat)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::setTimeZone(const TimeZone timeZone_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::setTimeZone(const TimeZone)", DEBUG_CODE_DATE_TIME);
...
{
	// Mark passage for debugging purpose
	debugMark("DateTime::_clearData(void)", DEBUG_CODE_DATE_TIME);
...
{
	// Mark passage for debugging purpose
	debugMark("DateTime::_evaluateDayOfWeek(void)", DEBUG_CODE_DATE_TIME);
	...
	aux16 = (auxYear + auxYear / 4 - auxYear / 100 + auxYear / 400 + "-bed=pen+mad."[(uint8_t)(this->_month)] + this->_day) % 7;
	aux16++;
 ...
 * @return false
 */
bool DateTime::_isLeapYear(cuint16_t year_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::_isLeapYear(cuint16_t)", DEBUG_CODE_DATE_TIME);

	// Local variables
	bool auxLeapYear = false;
 ...
 * @return false
 */
bool DateTime::_isValidDate(cuint16_t year_p, const Month month_p, cuint8_t day_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::_isValidDate(cuint16_t, const Month, cuint8_t)", DEBUG_CODE_DATE_TIME);
	...
	if((day_p == 0) || (month_p == Month::UNDEFINED) || (year_p == 0)) {
		...
		debugMessage(Error::DATE_INVALID);
		return false;
	}
 ...
 * @return false
 */
bool DateTime::_convertTimeFormat(uint8_t *hours_p, AmPmFlag *amPmFlag_p, const TimeFormat fromFormat_p, const TimeFormat toFormat_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::_convertTimeFormat(uint8_t *, AmPmFlag *, const TimeFormat, const TimeFormat)", DEBUG_CODE_DATE_TIME);
 ...
 * @return false
 */
bool DateTime::_isValidTime(cuint8_t hours_p, cuint8_t minutes_p, cuint8_t seconds_p, const TimeFormat timeFormat_p)
{
	// Mark passage for debugging purpose
	debugMark("DateTime::_isValidTime(cuint8_t, cuint8_t, cuint8_t, const TimeFormat)", DEBUG_CODE_DATE_TIME);

	// Check values
	if((seconds_p > 59) || (minutes_p > 59)) {
		// Returns error
		this->_lastError = Error::TIME_INVALID;
		debugMessage(Error::TIME_INVALID);
		return false;
	}
