...
enum class Error : uint16_t {
	...
	GPIO_PIN_INVALID									= 0x00D6,	// Invalid GPIO Pin
	MESSAGE_TOO_LONG									= 0x00D7,	// Message is to long to be stored inside buffer
	VALID_DATA_UNAVAILABLE								= 0x00D8,	// Valid data was unavailable
