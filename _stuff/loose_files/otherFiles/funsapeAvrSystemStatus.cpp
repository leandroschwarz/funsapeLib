...
#include "funsapeAvrSystemStatus.hpp"
#if __FUNSAPE_AVR_SYSTEM_STATUS_HPP != __BUILD_MACRO_TO_BE_CHANGED__
#	error [funsapeAvrSystemStatus.cpp] Build mismatch on header and source code files.
#endif
...
bool SystemStatus::setClockPrescaler(systemClockPrescaler_e prescaler)
{
	...
	case SYSTEM_CLOCK_PRESCALER_256:
		...
		break;
	default:
		this->_lastError = Error::CLOCK_PRESCALER_UNSUPPORTED;
		return false;
	}
