...
#define SPI_BB_SCLK_Pin GPIO_PIN_8
#define SPI_BB_SCLK_GPIO_Port GPIOA
#define SPI_BB_MISO_Pin GPIO_PIN_9
#define SPI_BB_MISO_GPIO_Port GPIOA
#define SPI_BB_MOSI_Pin GPIO_PIN_10
#define SPI_BB_MOSI_GPIO_Port GPIOA
