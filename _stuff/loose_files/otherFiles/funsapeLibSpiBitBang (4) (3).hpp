...
public:
	...
	bool sendData(uint8_t *txBuffData, uint8_t *rxBuffData, uint8_t buffSize = 1);
	bool sendData(uint8_t reg, uint8_t *txBuffData, uint8_t *rxBuffData, uint8_t buffSize = 1);
	bool sendData(uint8_t reg, uint8_t *buffData, uint8_t buffSize = 1);
