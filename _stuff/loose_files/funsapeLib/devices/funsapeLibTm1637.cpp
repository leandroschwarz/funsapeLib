...
// ¬FUNCTION Tm1637::Tm1637(Gpio *, Gpio *)
...
// ¬FUNCTION Tm1637::init(Gpio *, Gpio *)
...
// ¬FUNCTION Tm1637::setAddressingMode(cbool_t)
...
// ¬FUNCTION Tm1637::setDisplayContrast(const Tm1637::Constrast)
bool_t Tm1637::setDisplayContrast(const Tm1637::Constrast contrastLevel_p)
{
    // Mark passage for debugging purpose
    debugMark("Tm1637::setDisplayContrast(const Tm1637::Contrast)", Debug::CodeIndex::TM1637_MODULE);
...
// ¬FUNCTION Tm1637::showDisplay(cbool_t)
...
// ¬FUNCTION Tm1637::writeDisplayData(cuint16_t, cuint8_t)
bool_t Tm1637::writeDisplayData(cuint16_t displayValue_p, cuint8_t base_p)
{
    ...
    uint16_t auxValue = displayValue_p;
    uint8_t aux8 = 0;
    ...
    for (uint8_t i = 0; i < 4; i++) {
        aux8 = (auxValue % base_p);
        auxValue /= (uint16_t)base_p;
...
// ¬FUNCTION Tm1637::writeDisplayData(cuint8_t, cuint8_t, cbool_t)
...
// ¬FUNCTION Tm1637::readKeypadData(uint8_t *)
bool_t Tm1637::readKeypadData(uint8_t *keyPressed_p)
{
    // Mark passage for debugging purpose
    debugMark("Tm1637::readKeypadData(uint8_t *)", Debug::CodeIndex::TM1637_MODULE);
