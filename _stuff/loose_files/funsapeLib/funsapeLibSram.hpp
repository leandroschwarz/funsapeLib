...
#       else
#           pragma message "SRAM HAL module is not enabled, therefore, SRAM module will not be compiled."
#       endif   // defined(HAL_SRAM_MODULE_ENABLED)
#   else
#       pragma message "HAL driver is not in use, therefore, SRAM module will not be compiled."
#   endif   // defined(USE_HAL_DRIVER)
#else
#   pragma message "Platform unsupported, therefore, SRAM module will not be compiled."
