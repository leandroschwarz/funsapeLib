...
#       else
#           pragma message "IWDG HAL module is not enabled, therefore, IWDG module will not be compiled."
#       endif   // defined(HAL_IWDG_MODULE_ENABLED)
#   else
#       pragma message "HAL driver is not in use, therefore, IWDG module will not be compiled."
#   endif   // defined(USE_HAL_DRIVER)
#else
#   pragma message "Platform unsupported, therefore, IWDG module will not be compiled."
