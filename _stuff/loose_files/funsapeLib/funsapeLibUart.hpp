...
#       else
#           pragma message "UART HAL module is not enabled, therefore, UART module will not be compiled."
#       endif   // defined(HAL_UART_MODULE_ENABLED)
#   else
#       pragma message "HAL driver is not in use, therefore, UART module will not be compiled."
#   endif   // defined(USE_HAL_DRIVER)
#else
#   pragma message "Platform unsupported, therefore, UART module will not be compiled."
