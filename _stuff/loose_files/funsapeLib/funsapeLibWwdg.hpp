...
#       else
#           pragma message "WWDG HAL module is not enabled, therefore, WWDG module will not be compiled."
#       endif   // defined(HAL_WWDG_MODULE_ENABLED)
#   else
#       pragma message "HAL driver is not in use, therefore, WWDG module will not be compiled."
#   endif   // defined(USE_HAL_DRIVER)
#else
#   pragma message "Platform unsupported, therefore, WWDG module will not be compiled."
