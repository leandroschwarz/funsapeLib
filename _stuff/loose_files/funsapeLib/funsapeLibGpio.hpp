...
#       else
#           pragma message "GPIO HAL module is not enabled, therefore, GPIO module will not be compiled."
#       endif   // defined(HAL_GPIO_MODULE_ENABLED)
#   else
#       pragma message "HAL driver is not in use, therefore, GPIO module will not be compiled."
#   endif   // defined(USE_HAL_DRIVER)
#else
#   pragma message "Platform unsupported, therefore, GPIO module will not be compiled."
