 ...
 * Detailed description of this element.
 *
 * @param[in] hideMarks_p description of this parameter
 * @return true
 * @return false
 */
bool_t Debug::hideMarks(cbool_t hideMarks_p)
{
    // Update data members
    this->_hideMarkMessages = hideMarks_p;
