...
#       else
#           pragma message "EXTI HAL module is not enabled, therefore, EXTI module will not be compiled."
#       endif   // defined(HAL_EXTI_MODULE_ENABLED)
#   else
#       pragma message "HAL driver is not in use, therefore, EXTI module will not be compiled."
#   endif   // defined(USE_HAL_DRIVER)
#else
#   pragma message "Platform unsupported, therefore, EXTI module will not be compiled."
