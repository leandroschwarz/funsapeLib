...
#       else
#           pragma message "I2S HAL module is not enabled, therefore, I2S module will not be compiled."
#       endif   // defined(HAL_I2S_MODULE_ENABLED)
#   else
#       pragma message "HAL driver is not in use, therefore, I2S module will not be compiled."
#   endif   // defined(USE_HAL_DRIVER)
#else
#   pragma message "Platform unsupported, therefore, I2S module will not be compiled."
