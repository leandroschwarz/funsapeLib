...
resultValue_t int1Config(portMode_t port, intSenseMode_t sense)
{
	...
	case PORT_OUTPUT_LOW:
		clrBit(INT1_PORT, INT1_BIT);
		setBit(INT1_DDR, INT1_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(INT1_PORT, INT1_BIT);
		setBit(INT1_DDR, INT1_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(INT1_PORT, INT1_BIT);
		clrBit(INT1_DDR, INT1_BIT);
		break;
...
resultValue_t int0Config(portMode_t port, intSenseMode_t sense)
{
	...
	switch(port) {
	case PORT_OUTPUT_LOW:
		clrBit(INT0_PORT, INT0_BIT);
		setBit(INT0_DDR, INT0_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(INT0_PORT, INT0_BIT);
		setBit(INT0_DDR, INT0_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(INT0_PORT, INT0_BIT);
		clrBit(INT0_DDR, INT0_BIT);
		break;
	case PORT_INPUT_PULL_UP:
		setBit(INT0_PORT, INT0_BIT);
		clrBit(INT0_DDR, INT0_BIT);
...
resultValue_t pcint7ActivateInterrupt(portMode_t port)
{
	switch(port) {
	case PORT_OUTPUT_LOW:
		clrBit(PCINT7_PORT, PCINT7_BIT);
		setBit(PCINT7_DDR, PCINT7_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(PCINT7_PORT, PCINT7_BIT);
		setBit(PCINT7_DDR, PCINT7_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(PCINT7_PORT, PCINT7_BIT);
		clrBit(PCINT7_DDR, PCINT7_BIT);
		break;
	case PORT_INPUT_PULL_UP:
		setBit(PCINT7_PORT, PCINT7_BIT);
		clrBit(PCINT7_DDR, PCINT7_BIT);
...
resultValue_t pcint6ActivateInterrupt(portMode_t port)
{
	switch(port) {
	case PORT_OUTPUT_LOW:
		clrBit(PCINT6_PORT, PCINT6_BIT);
		setBit(PCINT6_DDR, PCINT6_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(PCINT6_PORT, PCINT6_BIT);
		setBit(PCINT6_DDR, PCINT6_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(PCINT6_PORT, PCINT6_BIT);
		clrBit(PCINT6_DDR, PCINT6_BIT);
		break;
	case PORT_INPUT_PULL_UP:
		setBit(PCINT6_PORT, PCINT6_BIT);
		clrBit(PCINT6_DDR, PCINT6_BIT);
...
resultValue_t pcint5ActivateInterrupt(portMode_t port)
{
	switch(port) {
	case PORT_OUTPUT_LOW:
		clrBit(PCINT5_PORT, PCINT5_BIT);
		setBit(PCINT5_DDR, PCINT5_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(PCINT5_PORT, PCINT5_BIT);
		setBit(PCINT5_DDR, PCINT5_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(PCINT5_PORT, PCINT5_BIT);
		clrBit(PCINT5_DDR, PCINT5_BIT);
		break;
	case PORT_INPUT_PULL_UP:
		setBit(PCINT5_PORT, PCINT5_BIT);
		clrBit(PCINT5_DDR, PCINT5_BIT);
...
resultValue_t pcint4ActivateInterrupt(portMode_t port)
{
	switch(port) {
	case PORT_OUTPUT_LOW:
		clrBit(PCINT4_PORT, PCINT4_BIT);
		setBit(PCINT4_DDR, PCINT4_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(PCINT4_PORT, PCINT4_BIT);
		setBit(PCINT4_DDR, PCINT4_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(PCINT4_PORT, PCINT4_BIT);
		clrBit(PCINT4_DDR, PCINT4_BIT);
		break;
	case PORT_INPUT_PULL_UP:
		setBit(PCINT4_PORT, PCINT4_BIT);
		clrBit(PCINT4_DDR, PCINT4_BIT);
...
resultValue_t pcint3ActivateInterrupt(portMode_t port)
{
	switch(port) {
	case PORT_OUTPUT_LOW:
		clrBit(PCINT3_PORT, PCINT3_BIT);
		setBit(PCINT3_DDR, PCINT3_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(PCINT3_PORT, PCINT3_BIT);
		setBit(PCINT3_DDR, PCINT3_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(PCINT3_PORT, PCINT3_BIT);
		clrBit(PCINT3_DDR, PCINT3_BIT);
		break;
	case PORT_INPUT_PULL_UP:
		setBit(PCINT3_PORT, PCINT3_BIT);
		clrBit(PCINT3_DDR, PCINT3_BIT);
...
resultValue_t pcint2ActivateInterrupt(portMode_t port)
{
	switch(port) {
	case PORT_OUTPUT_LOW:
		clrBit(PCINT2_PORT, PCINT2_BIT);
		setBit(PCINT2_DDR, PCINT2_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(PCINT2_PORT, PCINT2_BIT);
		setBit(PCINT2_DDR, PCINT2_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(PCINT2_PORT, PCINT2_BIT);
		clrBit(PCINT2_DDR, PCINT2_BIT);
		break;
	case PORT_INPUT_PULL_UP:
		setBit(PCINT2_PORT, PCINT2_BIT);
		clrBit(PCINT2_DDR, PCINT2_BIT);
...
resultValue_t pcint1ActivateInterrupt(portMode_t port)
{
	switch(port) {
	case PORT_OUTPUT_LOW:
		clrBit(PCINT1_PORT, PCINT1_BIT);
		setBit(PCINT1_DDR, PCINT1_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(PCINT1_PORT, PCINT1_BIT);
		setBit(PCINT1_DDR, PCINT1_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(PCINT1_PORT, PCINT1_BIT);
		clrBit(PCINT1_DDR, PCINT1_BIT);
		break;
	case PORT_INPUT_PULL_UP:
		setBit(PCINT1_PORT, PCINT1_BIT);
		clrBit(PCINT1_DDR, PCINT1_BIT);
...
resultValue_t pcint0ActivateInterrupt(portMode_t port)
{
	switch(port) {
	case PORT_OUTPUT_LOW:
		clrBit(PCINT0_PORT, PCINT0_BIT);
		setBit(PCINT0_DDR, PCINT0_BIT);
		break;
	case PORT_OUTPUT_HIGH:
		setBit(PCINT0_PORT, PCINT0_BIT);
		setBit(PCINT0_DDR, PCINT0_BIT);
		break;
	case PORT_INPUT_TRISTATE:
		clrBit(PCINT0_PORT, PCINT0_BIT);
		clrBit(PCINT0_DDR, PCINT0_BIT);
		break;
	case PORT_INPUT_PULL_UP:
		setBit(PCINT0_PORT, PCINT0_BIT);
		clrBit(PCINT0_DDR, PCINT0_BIT);
