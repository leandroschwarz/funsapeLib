...
public:
	 ...
	 */
	enum class BusType {
		NONE							= 0,	//!< Used to test if the variable was previously setted
		OWI								= 1,	//!< One Wire Interface
		PARALLEL						= 2,	//!< Parallel bitbang
		SERIAL							= 3,	//!< Serial bitbang
		SPI								= 4,	//!< Serial Peripheral Interface
		TWI								= 5,	//!< Two Wire Interface
		UART							= 6,	//!< UART or USART bus interface
	};
