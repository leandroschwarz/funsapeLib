...
lcdResult_t lcdSetDataPort(volatile lcdConfiguration_t *lcd, volatile uint8 *dataDDR, volatile uint8 *dataPORT,
        volatile uint8 *dataPIN, uint8 dataFirst)
{
    lcd->dataDDR = dataDDR;
...
lcdResult_t lcdSetControlPort(volatile lcdConfiguration_t *lcd, volatile uint8 *controlDDR, volatile uint8 *controlPORT,
        uint8 controlE, uint8 controlRS, uint8 controlRW)
{
