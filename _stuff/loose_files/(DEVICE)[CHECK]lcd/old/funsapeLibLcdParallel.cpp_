...
bool LcdParallel::_holdGpio(void)
{
	...
	if(this->_controlE > 7) {			// High nibble
		setMask(this->_controlGpio->CRH, 0x03, (4 * (this->_controlE - 8)));		// Output
		clrMask(this->_controlGpio->CRH, 0x03, ((4 * (this->_controlE - 8)) + 2));	// Push-pull
	} else {							// Low nibble
		setMask(this->_controlGpio->CRL, 0x03, (4 * this->_controlE));				// Output
		clrMask(this->_controlGpio->CRL, 0x03, ((4 * this->_controlE) + 2));		// Push-pull
	}

	// Configures control port (RS pin)
	if(this->_controlRs > 7) {			// High nibble
		setMask(this->_controlGpio->CRH, 0x03, (4 * (this->_controlRs - 8)));		// Output
		clrMask(this->_controlGpio->CRH, 0x03, ((4 * (this->_controlRs - 8)) + 2));	// Push-pull
	} else {							// Low nibble
		setMask(this->_controlGpio->CRL, 0x03, (4 * this->_controlRs));				// Output
		clrMask(this->_controlGpio->CRL, 0x03, ((4 * this->_controlRs) + 2));		// Push-pull
	}

	if(this->_useBusyFlag) {
		// Configures control port (Rw pin)
		if(this->_controlRw > 7) {			// High nibble
			setMask(this->_controlGpio->CRH, 0x03, (4 * (this->_controlRw - 8)));		// Output
			clrMask(this->_controlGpio->CRH, 0x03, ((4 * (this->_controlRw - 8)) + 2));	// Push-pull
		} else {							// Low nibble
			setMask(this->_controlGpio->CRL, 0x03, (4 * this->_controlRw));				// Output
			clrMask(this->_controlGpio->CRL, 0x03, ((4 * this->_controlRw) + 2));		// Push-pull
		}
	}
	...
	for(uint8_t i = 0; i < dataLength; i++) {
		...
		if(auxPin > 7) {			// High nibble
			setMask(this->_dataGpio->CRH, 0x03, (4 * (auxPin - 8)));			// Output
			clrMask(this->_dataGpio->CRH, 0x03, ((4 * (auxPin - 8)) + 2));		// Push-pull
		} else {					// Low nibble
			setMask(this->_dataGpio->CRL, 0x03, (4 * auxPin));					// Output
			clrMask(this->_dataGpio->CRL, 0x03, ((4 * auxPin) + 2));			// Push-pull
		}
	}
...
bool LcdParallel::_releaseGpio(void)
{
	...
	// Configures control port (E pin)
	if(this->_controlE > 7) {			// High nibble
		clrMask(this->_controlGpio->CRH, 0x03, ((4 * (this->_controlE - 8)) + 2));	// Analog Mode
		setMask(this->_controlGpio->CRH, 0x01, ((4 * (this->_controlE - 8)) + 2));	// Floating input
		clrMask(this->_controlGpio->CRH, 0x03, (4 * (this->_controlE - 8)));		// Input
	} else {							// Low nibble
		clrMask(this->_controlGpio->CRL, 0x03, ((4 * this->_controlE) + 2));		// Analog Mode
		setMask(this->_controlGpio->CRL, 0x01, ((4 * this->_controlE) + 2));		// Floating input
		clrMask(this->_controlGpio->CRL, 0x03, (4 * this->_controlE));				// Input
	}

	// Configures control port (RS pin)
	if(this->_controlRs > 7) {			// High nibble
		clrMask(this->_controlGpio->CRH, 0x03, ((4 * (this->_controlRs - 8)) + 2));	// Analog Mode
		setMask(this->_controlGpio->CRH, 0x01, ((4 * (this->_controlRs - 8)) + 2));	// Floating input
		clrMask(this->_controlGpio->CRH, 0x03, (4 * (this->_controlRs - 8)));		// Input
	} else {							// Low nibble
		clrMask(this->_controlGpio->CRL, 0x03, ((4 * this->_controlRs) + 2));		// Analog Mode
		setMask(this->_controlGpio->CRL, 0x01, ((4 * this->_controlRs) + 2));		// Floating input
		clrMask(this->_controlGpio->CRL, 0x03, (4 * this->_controlRs));				// Input
	}

	if(this->_useBusyFlag) {
		// Configures control port (Rw pin)
		if(this->_controlRw > 7) {			// High nibble
			clrMask(this->_controlGpio->CRH, 0x03, ((4 * (this->_controlRw - 8)) + 2));	// Analog Mode
			setMask(this->_controlGpio->CRH, 0x01, ((4 * (this->_controlRw - 8)) + 2));	// Floating input
			clrMask(this->_controlGpio->CRH, 0x03, (4 * (this->_controlRw - 8)));		// Input
		} else {							// Low nibble
			clrMask(this->_controlGpio->CRL, 0x03, ((4 * this->_controlRw) + 2));		// Analog Mode
			setMask(this->_controlGpio->CRL, 0x01, ((4 * this->_controlRw) + 2));		// Floating input
			clrMask(this->_controlGpio->CRL, 0x03, (4 * this->_controlRw));				// Input
		}
	}
	...
	for(uint8_t i = 0; i < dataLength; i++) {
		uint8_t auxPin = i + this->_dataFirst;
		if(auxPin > 7) {			// High nibble
			clrMask(this->_controlGpio->CRH, 0x03, ((4 * (auxPin - 8)) + 2));	// Analog Mode
			setMask(this->_controlGpio->CRH, 0x01, ((4 * (auxPin - 8)) + 2));	// Floating input
			clrMask(this->_controlGpio->CRH, 0x03, (4 * (auxPin - 8)));			// Input
		} else {					// Low nibble
			clrMask(this->_controlGpio->CRL, 0x03, ((4 * auxPin) + 2));			// Analog Mode
			setMask(this->_controlGpio->CRL, 0x01, ((4 * auxPin) + 2));			// Floating input
			clrMask(this->_controlGpio->CRL, 0x03, (4 * auxPin));				// Input
		}
	}
