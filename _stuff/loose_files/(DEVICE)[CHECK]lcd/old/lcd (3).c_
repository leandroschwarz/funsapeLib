...
setBit(DDRC, PC5);
setBit(DDRC, PC4);
if(useBusyFlag){setBit(PORTC, PC5);}else{clrBit(PORTC, PC5);}
if(interface4Bits){setBit(PORTC, PC4);}else{clrBit(PORTC, PC4);}
...
void lcdEntryModeSet(lcd_t * lcd, lcdIncrementDecrement_t dir, lcdShiftOverwrite_t mode)
{
