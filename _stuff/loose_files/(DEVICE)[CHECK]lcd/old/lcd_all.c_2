...
void this->_waitUntilReady( * lcd)				// ONLY - FLAGGED MODE
{
	...
	*(lcd->dataDDR) = 0x00;										// ONLY - 8 BITS MODE
	clrMask(*(lcd->dataPORT), 0x0F, lcd->dataFirst);			// ONLY - 4 BITS MODE
	clrMask(*(lcd->dataDDR), 0x0F, lcd->dataFirst);				// ONLY - 4 BITS MODE
	...
	*(lcd->dataDDR) = 0xFF;										// ONLY - 8 BITS MODE
	clrMask(*(lcd->dataPORT), 0x0F, lcd->dataFirst);			// ONLY - 4 BITS MODE
	setMask(*(lcd->dataDDR), 0x0F, lcd->dataFirst);				// ONLY - 4 BITS MODE
