...
#define __FUNSAPE_LIB_PLATFORM_HPP              __BUILD_NUMBER__
...
#   error [funsapeLibPlatform.hpp] Error - Header file (funsapeLibAvrSupport.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_AVR_SUPPORT_HPP != __BUILD_NUMBER__
#   error [funsapeLibPlatform.hpp] Error - Build mismatch between (funsapeLibPlatform.hpp) and (funsapeLibAvrSupport.hpp) header files!
#endif

#include "funsapeLibStm32Support.hpp"
#ifndef __FUNSAPE_LIB_STM32_SUPPORT_HPP
#   error [funsapeLibPlatform.hpp] Error - Header file (funsapeLibStm32Support.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_STM32_SUPPORT_HPP != __BUILD_NUMBER__
#   error [funsapeLibPlatform.hpp] Error - Build mismatch between (funsapeLibPlatform.hpp) and (funsapeLibStm32Support.hpp) header files!
#endif
...
#   error [funsapeLibPlatform.hpp] Error - Microcontroller already defined!
#endif
...
#if !defined(_FUNSAPE_MCU)
#   error [funsapeLibPlatform.hpp] Error - Microcontroller not defined!
#endif
