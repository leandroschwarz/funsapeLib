...
#       else
#           warning SD_CARD HAL module is not enabled, therefore, SD_CARD module will not be compiled.
#       endif   // defined(HAL_SD_MODULE_ENABLED)
#   else
#       warning HAL driver is not in use, therefore, SD_CARD module will not be compiled.
#   endif   // defined(USE_HAL_DRIVER)
#else
#   warning Platform unsupported, therefore, SD_CARD module will not be compiled.
