...
#   error [funsapeLibPlatform.hpp] Error 1 - Header file (funsapeLibAvrSupport.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_AVR_SUPPORT_HPP != __BUILD_NUMBER__
#   error [funsapeLibPlatform.hpp] Error 2 - Build mismatch between (funsapeLibPlatform.hpp) and (funsapeLibAvrSupport.hpp) header files!
#endif

#include "funsapeLibStm32Support.hpp"
#ifndef __FUNSAPE_LIB_STM32_SUPPORT_HPP
#   error [funsapeLibPlatform.hpp] Error 1 - Header file (funsapeLibStm32Support.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_STM32_SUPPORT_HPP != __BUILD_NUMBER__
#   error [funsapeLibPlatform.hpp] Error 2 - Build mismatch between (funsapeLibPlatform.hpp) and (funsapeLibStm32Support.hpp) header files!
#endif
...
#else
#   error [funsapeLibPlatform.hpp] Error 5 - Unable to identify platform!
#endif
