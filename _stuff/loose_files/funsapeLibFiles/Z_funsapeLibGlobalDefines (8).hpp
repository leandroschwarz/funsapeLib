...
//    USART_GENERIC_ERROR
    ...
    CONTROLLER_NOT_SUPPORTED                            = 0x0D00,   // Unsupported controller
    DEVICE_ID_MATCH_FAILED                              = 0x0D01,   // Device ID doesn't match
    DMA_NOT_SUPPORTED                                   = 0x0D02,   // DMA interface mode is not supported for this module
    DMA_TRANSFER_ERROR                                  = 0x0D03,   // DMA transfer error
    GPIO_NO_PIN_SET                                     = 0x0D04,   // No pin selected at Gpio peripheral
    GPIO_PORT_INVALID                                   = 0x0D05,   // Invalid GPIO Port
    MESSAGE_TOO_LONG                                    = 0x0D06,   // Message is to long to be stored inside buffer
    VALID_DATA_NOT_AVAILABLE                            = 0x0D07,   // Valid data was unavailable
//    PERIPHERAL_NOT_READY
//    STOPWATCH_NOT_STARTED

    // Uncategorized error codes
    LCD_PORTS_NOT_SET                                   = 0x0E00,
