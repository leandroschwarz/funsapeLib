...
#   error [funsapeLibSpi.hpp] Error - Feature is unsupported or was not implemented for selected platform!
#elif !defined(HAL_SPI_MODULE_ENABLED)
#   error [funsapeLibSpi.hpp] Error - Module was not enabled in platform HAL files!
#endif
