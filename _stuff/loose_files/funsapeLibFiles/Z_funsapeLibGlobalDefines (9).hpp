...
// #define isAsciiLowerCaseLetter(charac)  ((bool_t)(((charac >= 'a') && (charac <= 'z')) ? true : false))
// #define isAsciiUpperCaseLetter(charac)  ((bool_t)(((charac >= 'A') && (charac <= 'Z')) ? true : false))
// #define isAsciiCommand(charac)          ((bool_t)((charac < ' ') ? true : false))
// #define isAsciiLetter(charac)           ((bool_t)((isAsciiLowerCaseLetter(charac) || (isAsciiUpperCaseLetter(charac)) ? true : false)))
// #define isAsciiNumber(charac)           ((bool_t)(((charac >= '0') && (charac <= '9')) ? true : false))
// #define isAsciiSymbol(charac)           ((bool_t)(((!isAsciiNumber(charac)) && (!isAsciiCommand(charac)) && (!isAsciiLetter(charac))) ? true : false))
#define isGpioPortValid(port)              ((bool_t)true)
#define isGpioPinValid(port, first, offset, length)    ((bool_t)true)
#define isPointerValid(ptr)             ((bool_t)((ptr) ? (bool)true : (bool)false))
