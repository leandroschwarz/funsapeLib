...
Gpio::Gpio(void)
{
    ...
    debugMark("Gpio::Gpio(void)", Debug::CodeIndex::GPIO_MODULE);
...
// @FUNC Gpio::Gpio(GPIO_TypeDef *, cuint16_t)
/**
 * @brief Construct a new Gpio:: Gpio object
 *
 * Detailed description of this element.
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::Gpio(GPIO_TypeDef *, cuint16_t)", Debug::CodeIndex::GPIO_MODULE);
...
// @FUNC Gpio::init(GPIO_TypeDef *, cuint16_t)
/**
 * @brief
 *
 * Detailed description of this element.
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::init(GPIO_TypeDef *, cuint16_t)", Debug::CodeIndex::GPIO_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::clr(void)", Debug::CodeIndex::GPIO_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::cpl(void)", Debug::CodeIndex::GPIO_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::read(void)", Debug::CodeIndex::GPIO_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::set(void)", Debug::CodeIndex::GPIO_MODULE);
...
// @FUNC Gpio::setMode(const Gpio::Mode)
/**
 * @brief
 *
 * Detailed description of this element.
 ...
 * @return false
 */
bool_t Gpio::setMode(const Gpio::Mode mode_p)
{
    // Mark passage for debugging purpose
    debugMark("Gpio::setMode(const Gpio::Mode)", Debug::CodeIndex::GPIO_MODULE);
    ...
    clrMaskOffset(auxCrRegister, 0b1111, auxPinOffset);
    setMaskOffset(auxCrRegister, auxMask, auxPinOffset);
...
// @FUNC Gpio::setOutputSpeed(const Gpio::Speed)
/**
 * @brief
 *
 * Detailed description of this element.
 ...
 * @return false
 */
bool_t Gpio::setOutputSpeed(const Gpio::Speed speed_p)
{
    // Mark passage for debugging purpose
    debugMark("Gpio::setOutputSpeed(const Gpio::Speed)", Debug::CodeIndex::GPIO_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::_clearData(void)", Debug::CodeIndex::GPIO_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::_deinitialize(void)", Debug::CodeIndex::GPIO_MODULE);
...
// @FUNC Gpio::_initialize(GPIO_Typedef *, cuint16_t)
/**
 * @brief
 *
 * Detailed description of this element.
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::_initialize(GPIO_TypeDef *, cuint16_t)", Debug::CodeIndex::GPIO_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Gpio::_isInitialized(void)", Debug::CodeIndex::GPIO_MODULE);
...
// =============================================================================
// END OF FILE - funsapeLibGpio.cpp
// =============================================================================
