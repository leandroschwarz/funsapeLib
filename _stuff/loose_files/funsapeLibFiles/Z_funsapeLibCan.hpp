...
#       else
#           warning CAN HAL module is not enabled, therefore, CAN module will not be compiled.
#       endif   // defined(HAL_CAN_MODULE_ENABLED)
#   else
#       warning HAL driver is not in use, therefore, CAN module will not be compiled.
#   endif   // defined(USE_HAL_DRIVER)
#else
#   warning Platform unsupported, therefore, CAN module will not be compiled.
