...
#   error [funsapeLibTwi.cpp] Error - Header file (funsapeLibTwi.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_TWI_HPP != __BUILD_NUMBER__
#   error [funsapeLibTwi.cpp] Error - Build mismatch between source (funsapeLibTwi.cpp) and header (funsapeLibTwi.hpp) files!
#endif
...
Twi::Twi(void)
{
    ...
    debugMark("Twi::Twi(void)", Debug::CodeIndex::TWI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Twi::readReg(cuint8_t, uint8_t *, cuint16_t)", Debug::CodeIndex::TWI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Twi::writeReg(cuint8_t, cuint8_t *, cuint16_t)", Debug::CodeIndex::TWI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Twi::setDevice(cuint16_t, cbool_t)", Debug::CodeIndex::TWI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Twi::getBusType(void)", Debug::CodeIndex::TWI_MODULE);
 ...
 * @return false
 */
bool_t Twi::init(I2C_HandleTypeDef *busHandler_p, cuint16_t bufSize_p)
{
    // Mark passage for debugging purpose
    debugMark("Twi::init(I2C_HandleTypeDef *, cuint16_t)", Debug::CodeIndex::TWI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Twi::setTimeout(cuint16_t)", Debug::CodeIndex::TWI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Twi::_clearData(void)", Debug::CodeIndex::TWI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Twi::_deinitialize(void)", Debug::CodeIndex::TWI_MODULE);
 ...
 * @return false
 */
bool_t Twi::_initialize(void)
{
    // Mark passage for debugging purpose
    debugMark("Twi::_initialize(void)", Debug::CodeIndex::TWI_MODULE);
 ...
 * @return false
 */
bool_t Twi::_isInitialized(void)
{
    // Mark passage for debugging purpose
    debugMark("Twi::_isInitialized(void)", Debug::CodeIndex::TWI_MODULE);
 ...
 * @return false
 */
bool_t Twi::_transmit(void)
{
    // Mark passage for debugging purpose
    debugMark("Twi::_transmit(void)", Debug::CodeIndex::TWI_MODULE);
