...
Tm1637::Tm1637(const Gpio *dioPin_p, const Gpio *clkPin_p)
{
    // Mark passage for debugging purpose
    debugMark("Tm1637::Tm1637(const Gpio *, const Gpio *)", Debug::CodeIndex::TM1637_MODULE);
...
bool_t Tm1637::init(const Gpio *dioPin_p, const Gpio *clkPin_p)
{
    // Mark passage for debugging purpose
