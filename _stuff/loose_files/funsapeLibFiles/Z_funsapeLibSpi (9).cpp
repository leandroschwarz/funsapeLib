...
Spi::Spi(void)
{
    ...
    debugMark("Spi::Spi(void)", Debug::CodeIndex::SPI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Spi::readReg(cuint8_t, uint8_t *, cuint16_t)", Debug::CodeIndex::SPI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Spi::sendData(uint8_t *, cuint16_t)", Debug::CodeIndex::SPI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Spi::sendData(cuint8_t *, uint8_t *, cuint16_t)", Debug::CodeIndex::SPI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Spi::writeReg(cuint8_t, cuint8_t *, cuint16_t)", Debug::CodeIndex::SPI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Spi::setDevice(void (*)(void), void (*)(void))", Debug::CodeIndex::SPI_MODULE);
 ...
 * @return false
 */
bool_t Spi::setDevice(Gpio *csPin_p)
{
    // Mark passage for debugging purpose
    debugMark("Spi::setDevice(Gpio *)", Debug::CodeIndex::SPI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Spi::getBusType(void)", Debug::CodeIndex::SPI_MODULE);
 ...
 * @return false
 */
bool_t Spi::changeMode(const SpiMode mode_p)
{
    // Mark passage for debugging purpose
    debugMark("Spi::changeMode(const SpiMode)", Debug::CodeIndex::SPI_MODULE);
 ...
 * @return false
 */
bool_t Spi::init(SPI_HandleTypeDef *busHandler_p, cuint16_t bufSize_p)
{
    // Mark passage for debugging purpose
    debugMark("Spi::init(SPI_HandleTypeDef *, cuint16_t)", Debug::CodeIndex::SPI_MODULE);
 ...
 * @return false
 */
bool_t Spi::init(SPI_HandleTypeDef *busHandler_p, cuint16_t rxBufSize_p, cuint16_t txBufSize_p)
{
    // Mark passage for debugging purpose
    debugMark("Spi::init(SPI_HandleTypeDef *, cuint16_t, cuint16_t)", Debug::CodeIndex::SPI_MODULE);
 ...
 * @return false
 */
bool_t Spi::setTimeout(cuint16_t timeout_p)
{
    // Mark passage for debugging purpose
    debugMark("Spi::setTimeout(cuint16_t)", Debug::CodeIndex::SPI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Spi::_clearData(void)", Debug::CodeIndex::SPI_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Spi::_deinitilize(void)", Debug::CodeIndex::SPI_MODULE);
 ...
 * @return false
 */
bool_t Spi::_initialize(void)
{
    // Mark passage for debugging purpose
    debugMark("Spi::_initialize(void)", Debug::CodeIndex::SPI_MODULE);
    ...
    // Update data members
    bool_t clkPolarity = (bool_t)(this->_busHandler->Init.CLKPolarity);
    bool_t clkPhase = (bool_t)(this->_busHandler->Init.CLKPhase);
    ...
    this->_crcCalculationEnabled    = (bool_t)(this->_busHandler->Init.CRCCalculation);
    this->_crcPolynomial            = this->_busHandler->Init.CRCPolynomial;
    this->_csManagement             = (SpiCsManagement)(this->_busHandler->Init.NSS);
    this->_dataSize16BitsEnabled    = (bool_t)(this->_busHandler->Init.DataSize);
    this->_direction                = (SpiDirection)(this->_busHandler->Init.Direction);
    this->_lsbFirstEnabled          = (bool_t)(this->_busHandler->Init.FirstBit);
    this->_masterModeEnabled        = (bool_t)(this->_busHandler->Init.Mode);
 ...
 * @return false
 */
bool_t Spi::_isInitialized(void)
{
    // Mark passage for debugging purpose
    debugMark("Spi::_isInitialized(void)", Debug::CodeIndex::SPI_MODULE);
 ...
 * @return false
 */
bool_t Spi::_transmit(void)
{
    // Mark passage for debugging purpose
    debugMark("Spi::_transmit(void)", Debug::CodeIndex::SPI_MODULE);
