...
#   error [funsapeLibDs1307.hpp] Error - Feature is unsupported or was not implemented for selected platform!
#elif !defined(HAL_I2C_MODULE_ENABLED)
#   error [funsapeLibDs1307.hpp] Error - Module was not enabled in platform HAL files!
#endif
