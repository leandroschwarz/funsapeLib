...
#	error	[funsapeLibProjectConfig.hpp] Error 1 - Header file (funsapeLibPlatform.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_PLATFORM_HPP != __BUILD_NUMBER__
#	error	[funsapeLibProjectConfig.hpp] Error 2 - Build mismatch between (funsapeLibProjectConfig.hpp) and (funsapeLibPlatform.hpp) header files!
#endif
...
#		include "stm32l4xx.h"
#	else
#	error	[funsapeLibProjectConfig.hpp] Error 6 - Microcontroller unsupported!
#	endif
#endif
