...
#define __FUNSAPE_LIB_PROJECT_CONFIG_HPP        __BUILD_NUMBER__
...
// Header files
#include "funsapeLibPlatform.hpp"
...
#elif __FUNSAPE_LIB_PLATFORM_HPP != __BUILD_NUMBER__
#   error [funsapeLibProjectConfig.hpp] Error - Build mismatch between (funsapeLibProjectConfig.hpp) and (funsapeLibPlatform.hpp) header files!
#endif
...
#       include "stm32l4xx.h"
#   else
#   error [funsapeLibProjectConfig.hpp] Error - Microcontroller unsupported!
#   endif
#endif
