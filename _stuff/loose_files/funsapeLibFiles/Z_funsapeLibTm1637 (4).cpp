...
{
    // Mark passage for debugging purpose
    debugMark("Tm1637::init(Gpio *, Gpio *)", Debug::CodeIndex::TM1637_MODULE);
...
bool_t Tm1637::setAddressingMode(bool_t useAutoIncrementMode_p)
{
    // Mark passage for debugging purpose
    debugMark("Tm1637::setAddressingMode(bool_t)", Debug::CodeIndex::TM1637_MODULE);
...
bool_t Tm1637::setDisplayContrast(Constrast contrastLevel_p)
{
    // Mark passage for debugging purpose
    debugMark("Tm1637::setDisplayContrast(Contrast)", Debug::CodeIndex::TM1637_MODULE);
...
bool_t Tm1637::showDisplay(bool_t showDisplay_p)
{
    // Mark passage for debugging purpose
    debugMark("Tm1637::showDisplay(bool_t)", Debug::CodeIndex::TM1637_MODULE);
...
bool_t Tm1637::writeDisplayData(uint16_t displayValue_p, uint8_t base_p)
{
    // Mark passage for debugging purpose
    debugMark("Tm1637::writeDisplayData(uint16_t, uint8_t)", Debug::CodeIndex::TM1637_MODULE);
    ...
    for (uint8_t i = 0; i < 4; i++) {
        aux8 = (displayValue_p % base_p);
        displayValue_p /= (uint16_t)base_p;
...
bool_t Tm1637::writeDisplayData(uint8_t segments_p, uint8_t index_p, bool_t showDot_p)
{
    // Mark passage for debugging purpose
    debugMark("Tm1637::writeDisplayData(uint8_t, uint8_t, bool_t)", Debug::CodeIndex::TM1637_MODULE);
...
void Tm1637::_writeByte(uint8_t byteToWrite_p)
{
