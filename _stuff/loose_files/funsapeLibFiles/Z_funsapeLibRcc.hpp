...
#       else
#           warning RCC HAL module is not enabled, therefore, RCC module will not be compiled.
#       endif   // defined(HAL_RCC_MODULE_ENABLED)
#   else
#       warning HAL driver is not in use, therefore, RCC module will not be compiled.
#   endif   // defined(USE_HAL_DRIVER)
#else
#   warning Platform unsupported, therefore, RCC module will not be compiled.
