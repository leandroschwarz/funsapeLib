...
{
    // Mark passage for debugging purpose
    debugMark("Ds1307::countingResume(void)", Debug::CodeIndex::DS1307_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Ds1307::countingStop(void)", Debug::CodeIndex::DS1307_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Ds1307::init(void)", Debug::CodeIndex::DS1307_MODULE);
...
{
    // Mark passage for debugging purpose
    debugMark("Ds1307::setSquareWaveGenerator(SquareWave)", Debug::CodeIndex::DS1307_MODULE);
