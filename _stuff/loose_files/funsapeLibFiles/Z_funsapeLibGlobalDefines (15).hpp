...
#else
#   define ignored(var)                    __attribute__((unused))
#endif
...
// HAL modules
#define DEBUG_CODE_ADC                  (1UL << 0)
#define DEBUG_CODE_CAN                  (1UL << 1)
#define DEBUG_CODE_CEC                  (1UL << 2)
#define DEBUG_CODE_CORTEX               (1UL << 3)
#define DEBUG_CODE_CRC                  (1UL << 4)
#define DEBUG_CODE_DAC                  (1UL << 5)
#define DEBUG_CODE_DMA                  (1UL << 6)
#define DEBUG_CODE_ETH                  (1UL << 7)
#define DEBUG_CODE_EXTI                 (1UL << 8)
#define DEBUG_CODE_FLASH                (1UL << 9)
#define DEBUG_CODE_GPIO                 (1UL << 10)
#define DEBUG_CODE_HCD                  (1UL << 11)
#define DEBUG_CODE_I2S                  (1UL << 12)
#define DEBUG_CODE_IRDA                 (1UL << 13)
#define DEBUG_CODE_IWDG                 (1UL << 14)
#define DEBUG_CODE_MMC                  (1UL << 15)
#define DEBUG_CODE_NAND                 (1UL << 16)
#define DEBUG_CODE_NOR                  (1UL << 17)
#define DEBUG_CODE_PC_CARD              (1UL << 18)
#define DEBUG_CODE_PCD                  (1UL << 19)
#define DEBUG_CODE_PWR                  (1UL << 20)
#define DEBUG_CODE_RCC                  (1UL << 21)
#define DEBUG_CODE_RTC                  (1UL << 22)
#define DEBUG_CODE_SD_CARD              (1UL << 23)
#define DEBUG_CODE_SMART_CARD           (1UL << 24)
#define DEBUG_CODE_SPI                  (1UL << 25)
#define DEBUG_CODE_SRAM                 (1UL << 26)
#define DEBUG_CODE_TIMER                (1UL << 27)
#define DEBUG_CODE_TM1637               (1UL << 28)
#define DEBUG_CODE_TWI                  (1UL << 29)
#define DEBUG_CODE_UART                 (1UL << 30)
#define DEBUG_CODE_USART                (1UL << 31)
#define DEBUG_CODE_WWDG                 (1UL << 32)

// FunSAPE Library
#define DEBUG_CODE_BUS                  (1UL << 20)
#define DEBUG_CODE_CIRCULAR_BUFFER      (1UL << 21)
#define DEBUG_CODE_DATE_TIME            (1UL << 22)
#define DEBUG_CODE_DS1307               (1UL << 23)
#define DEBUG_CODE_MAX3010X             (1UL << 24)
#define DEBUG_CODE_MPU                  (1UL << 25)
#define DEBUG_CODE_STOPWATCH            (1UL << 26)
#define DEBUG_CODE_USB                  (1UL << 27)
...
#define isFlagSet(reg, flag)            ((bool_t)((reg) & (flag)))
#define isFlagClr(reg, flag)            ((bool_t)(!((reg) & (flag))))
...
#define isPointerValid(ptr)             ((ptr) ? (bool_t)true : (bool_t)false)
