...
#define __FUNSAPE_LIB_DATE_TIME_HPP             __BUILD_NUMBER__
...
private:
    ...
    //     /////////////////     DATE DATA MEMBERS     //////////////////     //
uint8_t         _day            :
    5;        // Month day number; valid values in range [1 to 31], 0 is reserved for NOT DEFINED
    bool            _leapYear       : 1;        // If the year is a leap year
    Month
    _month;                     // Month number; valid values in range [1 to 12], 0 is reserved for NOT DEFINED
uint16_t        _year           :
    14;       // Year in four digits format valid values in range [1 to 9999], 0 is reserved for NOT DEFINED
    WeekDay
    _weekDay;                   // Week day number; valid values in range [1 to 7], 0 is reserved for NOT DEFINED

    //     /////////////////     TIME DATA MEMBERS     //////////////////     //
    AmPmFlag        _amPmFlag;                  // Time flag if AM/PM mode is set
uint8_t         _hours          :
    5;        // Hour in 24-hours format; valid values in range [0 to 24], 25 is reserved for NOT DEFINED
