...
#   error [funsapeLibBus.hpp] Error - Global definitions file (funsapeLibGlobalDefines.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_GLOBAL_DEFINES_HPP != __BUILD_NUMBER__
#   error [funsapeLibBus.hpp] Error - Build mismatch between global definitions file (funsapeLibGlobalDefines.hpp) and current header file (funsapeLibBus.hpp)!
#endif
...
#   error [funsapeLibBus.hpp] Error - Required module (funsapeLibDebug.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_DEBUG_HPP != __BUILD_NUMBER__
#   error [funsapeLibBus.hpp] Error - Build mismatch between required module (funsapeLibDebug.hpp) and current header file (funsapeLibBus.hpp)!
#endif

#include "../funsapeLibGpio.hpp"
#ifndef __FUNSAPE_LIB_GPIO_HPP
#   error [funsapeLibBus.hpp] Error - Required module (funsapeLibGpio.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_GPIO_HPP != __BUILD_NUMBER__
#   error [funsapeLibBus.hpp] Error - Build mismatch between required module (funsapeLibGpio.hpp) and current header file (funsapeLibBus.hpp)!
#endif
...
public:
    ...
    virtual bool readReg(
        ...
        debugMark("Bus::readReg(cuint8_t, uint8_t *, cuint16_t)", Debug::CodeIndex::BUS_MODULE);
    ...
    virtual bool sendData(
        ...
        // Mark passage for debugging purpose
        debugMark("Bus::sendData(uint8_t *, cuint16_t)", Debug::CodeIndex::BUS_MODULE);
    ...
    virtual bool sendData(
        ...
        // Mark passage for debugging purpose
        debugMark("Bus::sendData(cuint8_t *, uint8_t *, cuint16_t)", Debug::CodeIndex::BUS_MODULE);
    ...
    virtual bool writeReg(
        ...
        // Mark passage for debugging purpose
        debugMark("Bus::writeReg(cuint8_t, cuint8_t *, cuint16_t)", Debug::CodeIndex::BUS_MODULE);
    ...
    virtual bool setDevice(
        ...
        // Mark passage for debugging purpose
        debugMark("Bus::setDevice(cuint16_t, cbool)", Debug::CodeIndex::BUS_MODULE);
    ...
    virtual bool setDevice(
        ...
        // Mark passage for debugging purpose
        debugMark("Bus::setDevice(Gpio *)", Debug::CodeIndex::BUS_MODULE);
    ...
    virtual bool setDevice(
        ...
        // Mark passage for debugging purpose
        debugMark("Bus::setDevice(void *(void), void *(void))", Debug::CodeIndex::BUS_MODULE);
    ...
    // ) {
    //     // Mark passage for debugging purpose
    //     debugMark("Bus::setDevice(const Gpio *)", Debug::CodeIndex::BUS_MODULE);
    ...
    virtual Bus::BusType getBusType(void) {
        // Mark passage for debugging purpose
        debugMark("Bus::getBusType(void)", Debug::CodeIndex::BUS_MODULE);
