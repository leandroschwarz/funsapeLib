...
#           else
#              warning GPIO HAL module is not enabled, therefore, SPI module will not be compiled.
#           endif   // defined(HAL_GPIO_MODULE_ENABLED)
#       else
#           warning SPI HAL module is not enabled, therefore, SPI module will not be compiled.
#       endif   // defined(HAL_SPI_MODULE_ENABLED)
#   else
#       warning HAL driver is not in use, therefore, SPI module will not be compiled.
#   endif   // defined(USE_HAL_DRIVER)
#else
#   warning Platform unsupported, therefore, SPI module will not be compiled.
