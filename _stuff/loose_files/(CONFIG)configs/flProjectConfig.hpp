...
#define __FL_PROJECT_CONFIG_HPP					__BUILD_TO_REPLACE__
...
// Header files
#include "parts/flPlatform.hpp"
#ifndef __FL_PLATFORM_HPP
#	error [flProjectConfig.hpp] Error 1 - Header file (flPlatform.hpp) must be corrupted!
#elif __FL_PLATFORM_HPP != __BUILD_TO_REPLACE__
#	error [flProjectConfig.hpp] Error 2 - Build mismatch between (flProjectConfig.hpp) and (flPlatform.hpp) header files!
#endif
...
#		include "stm32l4xx.h"
#	else
#	error [flProjectConfig.hpp] Error 6 - Microcontroller unsupported!
#	endif
#endif

#endif // __FL_PROJECT_CONFIG_HPP
