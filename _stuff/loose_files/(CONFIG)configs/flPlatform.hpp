...
#ifndef __FL_PLATFORM_HPP
#define __FL_PLATFORM_HPP						__BUILD_TO_REPLACE__
...
#include "flAvrSupport.hpp"
#ifndef __FL_AVR_SUPPORT_HPP
#	error [flPlatform.hpp] Error 1 - Header file (flAvrSupport.hpp) must be corrupted!
#elif __FL_AVR_SUPPORT_HPP != __BUILD_TO_REPLACE__
#	error [flPlatform.hpp] Error 2 - Build mismatch between (flPlatform.hpp) and (flAvrSupport.hpp) header files!
#endif

#include "flStm32Support.hpp"
#ifndef __FL_STM32_SUPPORT_HPP
#	error [flPlatform.hpp] Error 1 - Header file (flStm32Support.hpp) must be corrupted!
#elif __FL_STM32_SUPPORT_HPP != __BUILD_TO_REPLACE__
#	error [flPlatform.hpp] Error 2 - Build mismatch between (flPlatform.hpp) and (flStm32Support.hpp) header files!
#endif
...
#	error	[flPlatform.hpp] Error 3 - Microcontroller already defined!
#endif
...
#if !defined(_FUNSAPE_MCU)
#	error	[flPlatform.hpp] Error 4 - Microcontroller not defined!
#endif
...
#else
#	error [flPlatform.hpp] Error 5 - Unable to identify platform!
#endif

#endif // __FL_PLATFORM_HPP
