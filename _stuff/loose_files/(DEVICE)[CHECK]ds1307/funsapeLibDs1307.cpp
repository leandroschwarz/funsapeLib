...
#	error	[funsapeLibDs1307.cpp] Error 16 - Header file (funsapeLibDs1307.hpp) is missing or corrupted!
#elif __FUNSAPE_LIB_DS1307_HPP != __BUILD_TO_REPLACE__
#	error	[funsapeLibDs1307.cpp] Error 17 - Build mismatch between source (funsapeLibDs1307.cpp) and header (funsapeLibDs1307.hpp) files!
#endif
 ...
 * @return
 */
bool Ds1307::countingResume(void)
{
	// Mark passage for debugging purpose
 ...
 * @return false
 */
bool Ds1307::init(Bus *busHandler_p)
{
	// Mark passage for debugging purpose
 ...
 * @return false
 */
bool Ds1307::setSquareWaveGenerator(SquareWave squareWave_p)
{
	// Mark passage for debugging purpose
	debugMark("Ds1307::setSquareWaveGenerator(SquareWave)", DEBUG_CODE_DS1307);

	// Local variables
	bool _squareWaveActivation;
	uint8_t _squareWaveFrequency;
	bool _squareWaveOffValue;
	uint8_t auxBuffer;
	...
	if(!this->_busHandler->setDevice(DS1307_DEVICE_ADDRESS)) {
		// Returns error
 ...
 * @return false
*/
bool Ds1307::getDate(uint16_t *year_p, uint8_t *month_p, uint8_t *monthDay_p, uint8_t *weekDay_p)
{
	// Mark passage for debugging purpose
 ...
 * @return false
*/
bool Ds1307::getDateTime(DateTime *dateTime_p)
{
	// Mark passage for debugging purpose
 ...
 * @return false
*/
bool Ds1307::setDate(uint16_t year_p, uint8_t month_p, uint8_t monthDay_p)
{
	// Mark passage for debugging purpose
 ...
 * @return false
*/
bool Ds1307::setDateTime(DateTime dateTime_p)
{
	// Mark passage for debugging purpose
 ...
 * @return false
*/
bool Ds1307::getTime(uint8_t *hours_p, uint8_t *minutes_p, uint8_t *seconds_p, DateTime::TimeFormat timeFormat_p, DateTime::AmPmFlag *amPmFlag_p)
{
	// Mark passage for debugging purpose
	debugMark("Ds1307::getTime(uint8_t *, uint8_t *, uint8_t *, DateTime::TimeFormat, DateTime::AmPmFlag *)", DEBUG_CODE_DS1307);
 ...
 * @return false
*/
bool Ds1307::setTime(uint8_t hours_p, uint8_t minutes_p, uint8_t seconds_p, DateTime::TimeFormat timeFormat_p, DateTime::AmPmFlag amPmFlag_p)
{
	// Mark passage for debugging purpose
 ...
 * @return false
*/
bool Ds1307::getRamData(uint8_t position_p, uint8_t *buffer_p, uint8_t size_p)
{
	// Mark passage for debugging purpose
	...
	if(position_p > (DS1307_RAM_SIZE - 1)) {
		// Returns error
	...
	if((position_p + size_p) > DS1307_RAM_SIZE) {
		// Returns error
		this->_lastError = Error::BUFFER_SIZE_TOO_LARGE;
		debugMessage(Error::BUFFER_SIZE_TOO_LARGE);
		return false;
 ...
 * @return false
*/
bool Ds1307::setRamData(uint8_t position_p, uint8_t *buffer_p, uint8_t size_p)
{
	// Mark passage for debugging purpose
 ...
 * @return false
 */
bool Ds1307::_isInitialized(void)
{
	// Mark passage for debugging purpose
 ...
 * @return false
 */
bool Ds1307::_setCounting(bool counting_p)
{
	// Mark passage for debugging purpose
