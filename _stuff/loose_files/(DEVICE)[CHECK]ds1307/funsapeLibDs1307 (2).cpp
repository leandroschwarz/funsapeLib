 ...
 * @return false
*/
bool Ds1307::getTime(uint8_t *hours_p, uint8_t *minutes_p, uint8_t *seconds_p, DateTime::TimeFormat timeFormat_p,
 ...
 * @return false
*/
bool Ds1307::setTime(uint8_t hours_p, uint8_t minutes_p, uint8_t seconds_p, DateTime::TimeFormat timeFormat_p,
        DateTime::AmPmFlag amPmFlag_p)
{
    // Mark passage for debugging purpose
