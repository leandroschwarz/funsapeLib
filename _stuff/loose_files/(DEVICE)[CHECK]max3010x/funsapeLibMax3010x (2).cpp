...
#elif __FUNSAPE_LIB_MAX3010X_HPP != __BUILD_TO_REPLACE__
...
Max3010x::Max3010x(PartId partId_p)
{
    ...
    debugMark("Max3010x::Max3010x(PartId)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::~Max3010x(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setFullScale(FullScale)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setHeartRateMode(uint8_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setMultiLedMode(Slot, Slot, Slot, Slot)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setResolution(Resolution)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setSampleRate(SampleRate)", DEBUG_CODE_MAX3010X);
...
bool Max3010x::setSpo2Mode(uint8_t redLedCurrent_p, uint8_t infraredLedCurrent_p)
{
    ...
    // Mark passage for debugging purpose
    debugMark("Max3010x::setSpo2Mode(uint8_t, uint8_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::init(Bus *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::reset(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::shutDown(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::wakeUp(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::configFifo(SampleAveraging, bool, uint8_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::flushFifo(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoOccupation(uint8_t *, uint8_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoData(uint8_t, uint16_t *, uint16_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoData(uint8_t, uint32_t *, uint32_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoData(uint8_t, uint16_t *, uint16_t *, uint16_t *, uint16_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoData(uint8_t, uint32_t *, uint32_t *, uint32_t *, uint32_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoNewestSample(uint16_t *, uint16_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoNewestSample(uint32_t *, uint32_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoNewestSample(uint16_t *, uint16_t *, uint16_t *, uint16_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoNewestSample(uint32_t *, uint32_t *, uint32_t *, uint32_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoOldestSample(uint16_t *, uint16_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoOldestSample(uint32_t *, uint32_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoOldestSample(uint16_t *, uint16_t *, uint16_t *, uint16_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getFifoOldestSample(uint32_t *, uint32_t *, uint32_t *, uint32_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setIntAmbLightCancOverflowCallback(void (*)(void))", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setIntDieTempReadyCallback(void (*)(void))", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setIntFifoAlmostFullCallback(void (*)(void))", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setIntNewFifoDataReadyCallback(void (*)(void))", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setIntPowerReadyCallback(void (*)(void))", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setIntProximityCallback(void (*)(void))", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::disableInterrupts(InterruptFlags)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::enableInterrupts(InterruptFlags)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setPilotLedCurrent(uint8_t, uint8_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setInfraredLedCurrent(uint8_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setPilotLedCurrent(uint8_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::setRedLedCurrent(uint8_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getTemperature(float *, ThermometricScale)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::getTemperature(int8_t *, uint8_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::startTemperatureRead(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_clearData(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_isInitialized(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_reset(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_read(Register, uint8_t *, uint16_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_write(Register, uint8_t *, uint16_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_getFifoInfo(void)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_getFifoReadPointer(uint8_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_getFifoWritePointer(uint8_t *)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_readFifoData(uint8_t, void *, void*, void*, void*, uint8_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_setFifoReadPointer(uint8_t)", DEBUG_CODE_MAX3010X);
...
{
    // Mark passage for debugging purpose
    debugMark("Max3010x::_setFifoWritePointer(uint8_t)", DEBUG_CODE_MAX3010X);
...
bool Max3010x::readAllRegs(RegisterMap *regMap_p)
{
    ...
    debugMark("Max3010x::readAllRegs(RegisterMap *)", DEBUG_CODE_MAX3010X);
