					...
					max30102SensorFullScale_e sensorFullScale)
{
	...
	twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_WRITE, auxBuff, 2);
						   ...
						   max30102LedCurrent_e infraredLedCurrent)
{
	...
	twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_WRITE, auxBuff, 3);
								  ...
								  bool refreshStatus)
{
	...
	if (refreshStatus) {
		...
		twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_WRITE, auxBuff, 1);
		twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_READ, auxBuff, 2);
...
bool Max30102::flushFifo(void)
{
	...
	auxBuff[2] = 0;
	auxBuff[3] = 0;
	twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_WRITE, auxBuff, 4);
...
bool Max30102::getFifoInfo_(void)
{
	...
	auxBuff[0] = MAX30102_REG_FIFO_WRITE_POINTER;
	twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_WRITE, auxBuff, 1);
	twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_READ, auxBuff, 3);
							 ...
							 uint8_t varSize)
{
	...
	twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_WRITE, &aux8, 1);
	...
	// Read data
	twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_READ, auxBuff, aux16);
...
uint8_t Max30102::getReadPointer()
{
	...
	twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_WRITE, auxBuff, 1);
	twiMaster.sendData(MAX30102_DEVICE_ADDRESS, TWI_READ, auxBuff, 1);
