...
void lcdTwiEntryModeSet(lcdTwi_s *lcd, lcdDisplayDirection_e dir, lcdDisplayMode_e mode)
{
    ...
    command |= (lcd->entryIncDec == LCD_DISPLAY_DIRECTION_INCREMENT) ? LCD_ENTRY_MODE_SET_INCREMENT :
...
void lcdTwiSetPort(lcdTwi_s *lcd, uint8_t controlE, uint8_t controlRs, uint8_t controlRw, uint8_t dataFirst,
