...
#	error	[flGpio.hpp] Error 10 - Global definitions file (flGlobalDefines.hpp) is missing or corrupted!
#elif __FL_GLOBAL_DEFINES_HPP != __BUILD_TO_REPLACE__
#	error	[flGpio.hpp] Error 11 - Build mismatch between (flGpio.hpp) and global definitions file (flGlobalDefines.hpp)!
#endif

#include "all/allGpio.hpp"
#ifndef __ALL_GPIO_HPP
#	error	[flGpio.hpp] Error 10 -
#elif __ALL_GPIO_HPP != __BUILD_TO_REPLACE__
#	error	[flGpio.hpp] Error 11 -
#endif
