...
#if __GPDSE_ARM_I2CI_H != __BUILD_MACRO_TO_BE_CHANGED__
...
bool I2c::sendData(uint8_t devAddress, twiOperation_t readWrite, uint8_t reg, uint8_t *msg, uint8_t msgSize)
{
...
void I2c::interruptHandler(void)
{
	...
	default:
		this->state_ = (twiState_e)I2c_STATUS_REG;		// Store I2c_STATUS_REG and automatically sets clears noErrors bit
