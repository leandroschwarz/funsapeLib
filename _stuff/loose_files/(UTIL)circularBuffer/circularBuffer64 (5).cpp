...
#	error	[circularBuffer64.cpp] Error 103 - Header file (circularBuffer64.hpp) must be corruted!
#elif __FUNSAPE_CIRCULAR_BUFFER_64_HPP != __BUILD_TO_REPLACE__
#	error	[circularBuffer64.cpp] Error 104 - Build mismatch between source (circularBuffer64.hpp) and header (circularBuffer64.hpp) files!
#endif
...
// =============================================================================
// CircularBuffer64 class - Constructors
// =============================================================================
...
CircularBuffer64::~CircularBuffer64(void)
{
	// Locking procedure
	this->_locked = true;						// Locks circular buffer
	this->_rdProtected = true;					// Protects against read operations
...
// =============================================================================
// CircularBuffer64 class - Public methods
// =============================================================================
...
bool CircularBuffer64::blockWrite(bool block)
{
...
bool CircularBuffer64::blockRead(bool block)
{
	// Checks for buffer initialization
	if (!this->_initialized) {
		this->_lastError = ERROR_NOT_INITIALIZED;
...
// =============================================================================
// CircularBuffer64 class - Private methods
// =============================================================================
...
// =============================================================================
// CircularBuffer64 class - Protected methods
// =============================================================================
