 ...
 * @return
 */
template<typename T> bool CircularBuffer<T>::init(uint16_t bufferSize_p, bool overwrite_p)
{
	// Mark passage for debugging purpose
	debugMark("CircularBuffer::init(uint16_t, bool)", DEBUG_CODE_CIRCULAR_BUFFER);
