 ...
 * Module:		8-bits data-wide circular buffer for GPDSE++ ARM Library project
...
#if __CIRCULAR_BUFFER_8_H != __BUILD_MACRO_TO_BE_CHANGED__
#	error Build mismatch on header and source code files (circularBuffer8).
#endif
...
bool inline __attribute__((always_inline)) CircularBuffer8::checkLocked_(void)
{
	if (this->locked_) {
...
bool inline __attribute__((always_inline)) CircularBuffer8::checkInitialized_(void)
{
...
bool inline __attribute__((always_inline)) CircularBuffer8::checkWriteProtected_(void)
{
...
bool inline __attribute__((always_inline)) CircularBuffer8::checkReadProtected_(void)
{
...
void inline __attribute__((always_inline)) CircularBuffer8::moveReadPointer_(void)
{
...
void inline __attribute__((always_inline)) CircularBuffer8::moveWritePointer_(void)
{
...
void inline __attribute__((always_inline)) CircularBuffer8::moveBothPointers_(void)
{
	this->wrIndex_++;							// Increments write pointer
	this->wrIndex_ %= this->maxSize_;			// Resolves write pointer overflow
	this->rdIndex_++;							// Increments read pointer
