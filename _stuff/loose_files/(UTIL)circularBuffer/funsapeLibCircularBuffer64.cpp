 ...
 * File name:		funsapeLibCircularBuffer64.cpp
...
#include "funsapeLibCircularBuffer64.hpp"
#if __FUNSAPE_LIB_CIRCULAR_BUFFER_64_HPP != __BUILD_TO_REPLACE__
#	error [funsapeLibCircularBuffer64.cpp] Error 102 - Build mismatch on header and source code files.
#endif
...
CircularBuffer64::CircularBuffer64(uint16_t bufferSize, bool overwrite)
{
	...
	// Allocate memory
	this->_data = (uint64_t *)calloc(bufferSize, sizeof(uint64_t));
...
bool inline __attribute__((always_inline)) CircularBuffer64::_checkLocked(void)
{
	if (this->_locked) {
...
bool inline __attribute__((always_inline)) CircularBuffer64::_checkInitialized(void)
{
...
bool inline __attribute__((always_inline)) CircularBuffer64::_checkWriteProtected(void)
{
...
bool inline __attribute__((always_inline)) CircularBuffer64::_checkReadProtected(void)
{
...
void inline __attribute__((always_inline)) CircularBuffer64::_moveReadPointer(void)
{
...
void inline __attribute__((always_inline)) CircularBuffer64::_moveWritePointer(void)
{
...
void inline __attribute__((always_inline)) CircularBuffer64::_moveBothPointers(void)
{
	this->_wrIndex++;							// Increments write pointer
	this->_wrIndex %= this->_maxSize;			// Resolves write pointer overflow
	this->_rdIndex++;							// Increments read pointer
