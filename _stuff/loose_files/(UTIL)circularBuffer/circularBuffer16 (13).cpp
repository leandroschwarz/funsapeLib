...
#ifndef __FUNSAPE_CIRCULAR_BUFFER_16_HPP
#	error	[circularBuffer16.cpp] Error 103 - Header file (circularBuffer16.hpp) must be corruted!
#elif __FUNSAPE_CIRCULAR_BUFFER_16_HPP != __BUILD_TO_REPLACE__
#	error	[circularBuffer16.cpp] Error 104 - Build mismatch between source (circularBuffer16.hpp) and header (circularBuffer16.hpp) files!
#endif
...
// =============================================================================
// CircularBuffer16 class - Constructors
// =============================================================================
...
CircularBuffer16::~CircularBuffer16(void)
{
	// Locking procedure
	this->_locked = true;						// Locks circular buffer
	this->_rdProtected = true;					// Protects against read operations
...
// =============================================================================
// CircularBuffer16 class - Public methods
// =============================================================================
...
bool CircularBuffer16::blockWrite(bool block)
{
...
bool CircularBuffer16::blockRead(bool block)
{
	// Checks for buffer initialization
	if (!this->_initialized) {
		this->_lastError = ERROR_NOT_INITIALIZED;
...
// =============================================================================
// CircularBuffer16 class - Private methods
// =============================================================================
...
// =============================================================================
// CircularBuffer16 class - Protected methods
// =============================================================================
