 ...
 * Module:			8-bits data-wide circular buffer for FunSAPE++ Embedded
 *					Library project
...
#ifndef __FUNSAPE_CIRCULAR_BUFFER_8_HPP
#define __FUNSAPE_CIRCULAR_BUFFER_8_HPP			__BUILD_TO_REPLACE__
...
#	error	[circularBuffer8.hpp] Error 105 - Global definitions file (globalDefines.hpp) is missing!
#elif __FUNSAPE_GLOBAL_DEFINES_HPP != __BUILD_TO_REPLACE__
#	error	[circularBuffer8.hpp] Error 106 - Build mismatch between header file (circularBuffer8.hpp) and global definitions file (globalDefines.hpp)!
#endif
...
protected:
	...
	// Constructors
public:
	CircularBuffer8(uint16_t bufferSize = 20, bool overwrite = false);
	~CircularBuffer8(void);
...
public:
	...
	bool		pop(uint8_t *data, bool keepData = false);
	//				Pushes an entire buffer into circular buffer
	bool		pushBuffer(uint8_t *bufData, uint16_t bufSize);
	//				Pops an entire buffer into circular buffer
	bool		popBuffer(uint8_t *bufData, uint16_t bufSize, bool keepData = false);
...
private:
	...
	uint8_t		*_data;							// TODO: Describe data member
...
// =============================================================================
// CircularBuffer8 - Class inline function definitions
// =============================================================================
...
#endif // __FUNSAPE_CIRCULAR_BUFFER_8_HPP
