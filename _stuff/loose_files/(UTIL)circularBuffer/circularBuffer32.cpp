 ...
 * Module:		32-bits data-wide circular buffer for GPDSE++ ARM Library project
...
#if __CIRCULAR_BUFFER_32_H != __BUILD_MACRO_TO_BE_CHANGED__
#	error Build mismatch on header and source code files (circularBuffer32).
#endif
