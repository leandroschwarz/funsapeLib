...
#	error	[circularBuffer8.cpp] Error 103 - Header file (circularBuffer8.hpp) must be corruted!
#elif __FUNSAPE_CIRCULAR_BUFFER_8_HPP != __BUILD_TO_REPLACE__
#	error	[circularBuffer8.cpp] Error 104 - Build mismatch between source (circularBuffer8.hpp) and header (circularBuffer8.hpp) files!
#endif
...
// =============================================================================
// CircularBuffer8 class - Constructors
// =============================================================================
...
CircularBuffer8::~CircularBuffer8(void)
{
	// Locking procedure
	this->_locked = true;						// Locks circular buffer
	this->_rdProtected = true;					// Protects against read operations
...
// =============================================================================
// CircularBuffer8 class - Public methods
// =============================================================================
...
bool CircularBuffer8::blockWrite(bool block)
{
...
bool CircularBuffer8::blockRead(bool block)
{
	// Checks for buffer initialization
	if (!this->_initialized) {
		this->_lastError = ERROR_NOT_INITIALIZED;
...
// =============================================================================
// CircularBuffer8 class - Private methods
// =============================================================================
...
// =============================================================================
// CircularBuffer8 class - Protected methods
// =============================================================================
