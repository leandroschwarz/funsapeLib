 ...
 * File name:		funsapeLibCircularBuffer8.cpp
...
#if __FUNSAPE_LIB_CIRCULAR_BUFFER_8_HPP != __BUILD_TO_REPLACE__
#	error [funsapeLibCircularBuffer8.cpp] Error 102 - Build mismatch on header and source code files.
#endif
