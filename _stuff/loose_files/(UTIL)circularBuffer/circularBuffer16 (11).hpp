...
#define __FUNSAPE_CIRCULAR_BUFFER_16_HPP		__BUILD_TO_REPLACE__
...
#	error	[circularBuffer16.hpp] Error 105 - Global definitions file (globalDefines.hpp) is missing!
#elif __FUNSAPE_GLOBAL_DEFINES_HPP != __BUILD_TO_REPLACE__
#	error	[circularBuffer16.hpp] Error 106 - Build mismatch between header file (circularBuffer16.hpp) and global definitions file (globalDefines.hpp)!
#endif
...
private:
	...
	uint16_t	*_data;							// TODO: Describe data member
...
#endif // __FUNSAPE_CIRCULAR_BUFFER_16_HPP
