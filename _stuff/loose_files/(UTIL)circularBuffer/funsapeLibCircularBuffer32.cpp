 ...
 * File name:		funsapeLibCircularBuffer32.cpp
...
#if __FUNSAPE_LIB_CIRCULAR_BUFFER_32_HPP != __BUILD_TO_REPLACE__
#	error [funsapeLibCircularBuffer32.cpp] Error 102 - Build mismatch on header and source code files.
#endif
...
bool inline __attribute__((always_inline)) CircularBuffer32::_checkLocked(void)
{
	if(this->_locked) {
...
bool inline __attribute__((always_inline)) CircularBuffer32::_checkInitialized(void)
{
...
bool inline __attribute__((always_inline)) CircularBuffer32::_checkWriteProtected(void)
{
...
bool inline __attribute__((always_inline)) CircularBuffer32::_checkReadProtected(void)
{
