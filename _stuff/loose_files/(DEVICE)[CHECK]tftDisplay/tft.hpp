...
#	error	[tft.hpp] Error 101 - Global definitions file (globalDefines.hpp) must be build 1002.
#endif
...
typedef enum tftDisplayModel {
	TFT_DISPLAY_CPLD			= 0,
	TFT_DISPLAY_HX8340B_8		= 1,
	TFT_DISPLAY_HX8340B_S		= 2,
	TFT_DISPLAY_HX8347A			= 3,
	TFT_DISPLAY_HX8352A			= 4,
	TFT_DISPLAY_HX8353C			= 5,
	TFT_DISPLAY_ILI9325C		= 6,
	TFT_DISPLAY_ILI9325D_16		= 7,
	TFT_DISPLAY_ILI9325D_16ALT	= 8,
	TFT_DISPLAY_ILI9325D_8		= 9,
	TFT_DISPLAY_ILI9327			= 10,
	TFT_DISPLAY_ILI9341_16		= 11,
	TFT_DISPLAY_ILI9341_S4P		= 12,
	TFT_DISPLAY_ILI9341_S5P		= 13,
	TFT_DISPLAY_ILI9481			= 14,
	TFT_DISPLAY_ILI9486			= 15,
	TFT_DISPLAY_PCF8833			= 16,
	TFT_DISPLAY_R61581			= 17,
	TFT_DISPLAY_S1D19122		= 18,
	TFT_DISPLAY_S6D0164			= 19,
	TFT_DISPLAY_S6D1121_16		= 20,
	TFT_DISPLAY_S6D1121_8		= 21,
	TFT_DISPLAY_SSD1289			= 22,
	TFT_DISPLAY_SSD1289_8		= 23,
	TFT_DISPLAY_SSD1289LATCHED	= 24,
	TFT_DISPLAY_SSD1963_480		= 25,
	TFT_DISPLAY_SSD1963_800		= 26,
	TFT_DISPLAY_SSD1963_800ALT	= 27,
	TFT_DISPLAY_ST7735			= 28,
	TFT_DISPLAY_ST7735_ALT		= 29,
	TFT_DISPLAY_ST7735S			= 30
} tftDisplayModel;
...
class Tft {
	// Constructors
	Tft(tftDisplayModel model);
	~Tft();

	// Methods - Public
public:
	bool init(	gpioPin_e rs, gpioPin_e rd, gpioPin_e wr, gpioPin_e reset,
				gpioPin_e cs, gpioPin_e dataHigh,
				gpioPin_e dataLow = GPIO_PIN_UNDEFINED);
	error_e getLastError(void);

	// Methods - Private
private:
	bool checkInitialize_(void);

	// Data members - Private
private:
	// Display configuration
	tftDisplayModel	displayModel_		: 5;
	uint16_t		displaySizeX_		: 10;
	uint16_t		displaySizeY_		: 10;
	interface_t		displayInterface_	: 4;
	...
	gpioPin_e		gpioRd_;
	gpioPin_e		gpioCs_;
	gpioPin_e		gpioReset_;
	gpioPin_e		gpioDataLow_;
	gpioPin_e		gpioDataHigh_;
