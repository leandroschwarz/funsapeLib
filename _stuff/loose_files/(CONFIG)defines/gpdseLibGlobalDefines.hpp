...
#define byteNibbleHigh(dataByte)		((dataByte >> 4) & 0x0F)
#define byteNibbleLow(dataByte)			(dataByte & 0x0F)
#define byteSwitchNibbles(dataByte)		((byteLowNibble(dataByte) << 4) | byteHighNibble(dataByte))
#define wordByteHigh(dataWord)			((dataWord >> 8) & 0x00FF)
#define wordByteLow(dataWord)			(dataWord & 0x00FF)
...
#define dwordWordHigh(dataDword)		((dataDword >> 16) & 0x0000FFFF)
#define dwordWordLow(dataDword)			(dataDword & 0x0000FFFF)
