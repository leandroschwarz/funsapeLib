...
/*!
	...
	\details	Here typically goes a more extensive explanation of what the header
				defines. Doxygens tags are words preceeded by either a backslash or
				by an at-symbol.
...
typedef enum error_e {
	...
	// PCINT	50-59
	// TIMER0	60-69
	ERROR_TIMER0_UNSUPPORTED_CONFIGURATION_CLOCK_PRESCALER			= 60,	//!< Timer0 clock prescaler value off limits		\hideinitializer
	ERROR_TIMER0_UNSUPPORTED_CONFIGURATION_MODE						= 61,	//!< Timer0 mode unsupported						\hideinitializer
	ERROR_TIMER0_UNSUPPORTED_CONFIGURATION_OUTPUT_COMPARE			= 62,	//!< Timer0 output pin configuration unsupported	\hideinitializer
	// TIMER1	70-79
	ERROR_TIMER1_UNSUPPORTED_CONFIGURATION_CLOCK_PRESCALER			= 70,	//!< Timer1 clock prescaler value off limits		\hideinitializer
	ERROR_TIMER1_UNSUPPORTED_CONFIGURATION_MODE						= 71,	//!< Timer1 mode unsupported						\hideinitializer
	ERROR_TIMER1_UNSUPPORTED_CONFIGURATION_OUTPUT_COMPARE			= 72,	//!< Timer1 output pin configuration unsupported	\hideinitializer
	ERROR_TIMER1_UNSUPPORTED_CONFIGURATION_CAPTURE_EDGE				= 73,	//!< Timer1 invalid edge section on capture mode	\hideinitializer
	ERROR_TIMER1_UNSUPPORTED_CONFIGURATION_CAPTURE_NOISE_CANCELER	= 74,	//!< Timer0 invalid noise canceler configuration	\hideinitializer
	// TIMER2	80-89
	ERROR_TIMER2_UNSUPPORTED_CONFIGURATION_CLOCK_PRESCALER			= 80,	//!< Timer2 clock prescaler value off limits		\hideinitializer
	ERROR_TIMER2_UNSUPPORTED_CONFIGURATION_MODE						= 81,	//!< Timer2 mode unsupported						\hideinitializer
	ERROR_TIMER2_UNSUPPORTED_CONFIGURATION_OUTPUT_COMPARE			= 82,	//!< Timer2 output pin configuration unsupported	\hideinitializer
	// ADC		110-119
...
*/
typedef enum systemPrescalerValue_e {
	SYSTEM_PRESCALER_NO_CHANGE	= 0,	//!< Keep last prescaler value
	SYSTEM_PRESCALER_1			= 1,	//!< Main clock
	SYSTEM_PRESCALER_2			= 2,	//!< Main clock divided by 2
	SYSTEM_PRESCALER_4			= 3,	//!< Main clock divided by 4
	SYSTEM_PRESCALER_8			= 4,	//!< Main clock divided by 8
	SYSTEM_PRESCALER_16			= 5,	//!< Main clock divided by 16
	SYSTEM_PRESCALER_32			= 6,	//!< Main clock divided by 32
	SYSTEM_PRESCALER_64			= 7,	//!< Main clock divided by 64
	SYSTEM_PRESCALER_128		= 8,	//!< Main clock divided by 128
	SYSTEM_PRESCALER_256		= 9		//!< Main clock divided by 256
} systemPrescalerValue_e;				//!< /private
...
typedef volatile struct systemConfiguration_s {
	uint16_t	systemClockKHz;		//!< System clock frequency (in kHz) to be used throughout the library.
...
\details	Sets the \a clock as the main system clock. The function will divide the given clock frequency value by 1000 to obtain the clock frequency in kilohertz. The value is store in the systemConfiguration_s structure.
