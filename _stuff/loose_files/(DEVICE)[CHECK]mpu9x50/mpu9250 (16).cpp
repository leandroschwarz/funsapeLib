...
#include "mpu9250.h"
#if __MPU9250_H != __BUILD_MACRO_TO_BE_CHANGED__
#	error Build mismatch on header and source code files (mpu9250).
#endif
...
*/
bool Mpu9250::initSpi(		Spi *spiHndlr,
...
/*
bool Mpu9250::performCalibration(void)
{
...
bool Mpu9250::performHardReset(void)
{
	uint8_t aux8 = 1 << MPU9250_BIT_PWR_MGMT_1_H_RESET;
...
void Mpu9250::dumpClassData_(void)
{
	// Boolean variables
	...
	// 8-bits variables
	this->accelDlpfCfg_ = 0;
	this->accelFullScale_ = 0;
	this->clockSelection_ = 0;
	this->extSyncSet_ = 0;
	this->gyroDlpfCfg_ = 0;
	this->gyroFChoiceB_ = 0;
	this->gyroFullScale_ = 0;
	...
	for (uint8_t i = 0; i < 3; i++) {
		...
		this->accelSelfTest_[i] = 0;
		this->gyroSelfTest_[i] = 0;
	}
