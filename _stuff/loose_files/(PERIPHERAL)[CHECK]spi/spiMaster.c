...
spiResult_t spiSetClockPrescaler(spiPrescalerValue_t prescaler)
{
	...
	switch(prescaler){
		...
		case SPI_PRESCALER_8:	setBit(reg2, SPI2X);	setMask(reg1, 0x01, SPR0);	break;
		case SPI_PRESCALER_16:	setMask(reg1, 0x01, SPR0);	break;
		case SPI_PRESCALER_32:	setBit(reg2, SPI2X);	setMask(reg1, 0x02, SPR0);	break;
		case SPI_PRESCALER_64:	setMask(reg1, 0x02, SPR0);	break;
		case SPI_PRESCALER_128:	setMask(reg1, 0x03, SPR0);	break;
