...
public:
	...
	///< Virtual drawPixel() function to draw to the screen/framebuffer/etc, must be overridden in subclass. @param x X coordinate.	@param y Y coordinate. @param color 16-bit pixel color.
...
private:
	Adafruit_GFX	*_gfx;
	int16_t			_x1;				// Coordinates of top-left corner
	int16_t			_y1;				// Coordinates of top-left corner
	uint16_t		_w;
	uint16_t		_h;
	uint8_t			_textsize_x;
	uint8_t			_textsize_y;
