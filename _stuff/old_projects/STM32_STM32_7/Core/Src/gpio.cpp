...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, NLED_Pin|SPI1_CS_MPU3_Pin|SPI1_CS_MPU2_Pin|SPI1_CS_MPU1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, DEBUG1_Pin|DEBUG2_Pin|DEBUG3_Pin|DEBUG4_Pin
                          |DEBUG5_Pin|DEBUG6_Pin|TFT_RD_Pin|TFT_WR_Pin
                          |TFT_RS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, DEBUG7_Pin|DEBUG8_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = NLED_Pin|SPI1_CS_MPU3_Pin|SPI1_CS_MPU2_Pin|SPI1_CS_MPU1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(DS1307_SWO_GPIO_Port, &GPIO_InitStruct);
