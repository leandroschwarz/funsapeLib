...
#if __CIRCULAR_BUFFER_8_HPP != __BUILD_MACRO_TO_BE_CHANGED__
#	error [circularBuffer8.cpp] Build mismatch on header and source code files.
#endif
...
bool inlined CircularBuffer8::_checkLocked(void)
{
	if (this->_locked) {
...
bool inlined CircularBuffer8::_checkInitialized(void)
{
...
bool inlined CircularBuffer8::_checkWriteProtected(void)
{
...
bool inlined CircularBuffer8::_checkReadProtected(void)
{
...
void inlined CircularBuffer8::_moveReadPointer(void)
{
...
void inlined CircularBuffer8::_moveWritePointer(void)
{
...
void inlined CircularBuffer8::_moveBothPointers(void)
{
	this->_wrIndex++;							// Increments write pointer
	this->_wrIndex %= this->_maxSize;			// Resolves write pointer overflow
	this->_rdIndex++;							// Increments read pointer
