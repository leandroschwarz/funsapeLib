...
typedef enum error_e {
	...
	ERROR_UNKNOWN,                                     // Something really unpredictable has happen
	...
	ERROR_BUFFER_SIZE_TOO_LARGE,                       // Buffer size was set to a large value
	...
	ERROR_ARGUMENTS_MISMATCH,                          // A function was called with dubious argument values
	ERROR_ARGUMENTS_WRONG_NUMBER,                      // A function was called with wrong number of arguments
	...
	ERROR_DATE_INVALID,
	ERROR_TIME_INVALID,
	ERROR_PACKAGE_API_PACKAGE_AWAITING,                // Try to write data to a ready package
	ERROR_PACKAGE_API_PACKAGE_NOT_READY,               // Try to read data from a not ready package
	ERROR_PACKAGE_API_FRAME_ERROR,
	ERROR_PACKAGE_API_CHECKSUM_ERROR,
