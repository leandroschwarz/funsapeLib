...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_D10_Pin|LCD_D11_Pin|LCD_D12_Pin|LCD_D13_Pin 
                          |LCD_D14_Pin|LCD_D15_Pin|LCD_RST_Pin|LCD_CS_Pin 
                          |LCD_RD_Pin|LCD_WR_Pin|LCD_RS_Pin|LCD_D8_Pin 
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin 
                           ...
                           PBPin PBPin PBPin PBPin 
                           PBPin */
  GPIO_InitStruct.Pin = LCD_D10_Pin|LCD_D11_Pin|LCD_D12_Pin|LCD_D13_Pin 
                          |LCD_D14_Pin|LCD_D15_Pin|LCD_RST_Pin|LCD_CS_Pin 
                          |LCD_RD_Pin|LCD_WR_Pin|LCD_RS_Pin|LCD_D8_Pin 
                          |LCD_D9_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
