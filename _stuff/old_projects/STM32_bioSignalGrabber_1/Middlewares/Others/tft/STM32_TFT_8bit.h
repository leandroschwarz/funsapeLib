...
#define TFT_RST        3
#define TFT_WR         4
#define TFT_CS_MASK    GPIO_PIN_0
#define TFT_RD_MASK    GPIO_PIN_1
#define TFT_RS_MASK    GPIO_PIN_2
#define TFT_RST_MASK   GPIO_PIN_3
#define TFT_WR_MASK    GPIO_PIN_4
...
#define RST_ACTIVE   TFT_CNTRL->BRR  = TFT_RST_MASK
#define RST_IDLE     TFT_CNTRL->BSRR  = TFT_RST_MASK
