...
#include "..\Drivers\CMSIS\Device\ST\STM32F0xx\Include\stm32f091xc.h"
...
// SPI configuration
#define SD_SPI_BAUD_RATE				SPI_BAUDRATEPRESCALER_16
...
#define SD_SCLK_AF						GPIO_AF0_SPI1
#define SD_SCLK_GPIO_PORT				GPIOB
#define SD_SCLK_PIN						GPIO_PIN_3
#define SD_SCLK_GPIO_CLK_ENABLE()		__HAL_RCC_GPIOB_CLK_ENABLE()
#define SD_SCLK_GPIO_CLK_DISABLE()		__HAL_RCC_GPIOB_CLK_DISABLE()
#define SD_MISO_MOSI_AF					GPIO_AF0_SPI1
#define SD_MISO_MOSI_GPIO_PORT			GPIOA
#define SD_MISO_MOSI_GPIO_CLK_ENABLE()	__HAL_RCC_GPIOA_CLK_ENABLE()
#define SD_MISO_MOSI_GPIO_CLK_DISABLE()	__HAL_RCC_GPIOA_CLK_DISABLE()
