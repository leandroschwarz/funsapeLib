...
#define SPI1_CS_MPU1_Pin GPIO_PIN_15
#define SPI1_CS_MPU1_GPIO_Port GPIOA
#define SPI1_CS_MPU2_Pin GPIO_PIN_3
#define SPI1_CS_MPU2_GPIO_Port GPIOB
#define SPI1_CS_MPU3_Pin GPIO_PIN_4
#define SPI1_CS_MPU3_GPIO_Port GPIOB
#define SPI1_CS_MPU4_Pin GPIO_PIN_5
#define SPI1_CS_MPU4_GPIO_Port GPIOB
...
#define ledPulseOn(delayMs)				do {					\
											ledTurnOn(); 		\
											HAL_Delay(delayMs);	\
											ledTurnOff();		\
											HAL_Delay(delayMs);	\
										} while (0)
#define ledPulseOff(delayMs)			do {					\
											ledTurnOff(); 		\
											HAL_Delay(delayMs);	\
											ledTurnOn();		\
											HAL_Delay(delayMs);	\
